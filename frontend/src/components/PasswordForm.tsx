          ...
          <div className="form-group">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ flex: 1 }}>
                ...
                {isDuplicate && <p className="error-message">This password is used for another account.</p>}
              </div>
              ...
              <button
                ...
                style={{ whiteSpace: 'nowrap', backgroundColor: 'var(--accent-primary)', color: 'white', fontSize: '14px',  }}
              >
                Generate
              </button>
            </div>
            <div className="password-feedback-container">
              {formData.password && (
                  <div className="password-feedback">
                      {passwordStrength.feedback.warning && <p className="warning">{passwordStrength.feedback.warning}</p>}
